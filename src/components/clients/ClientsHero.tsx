    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Trusted by{" "}
            <span className="text-ocean-400">Houston&apos;s Finest</span>
          </motion.h1>
          <motion.p
            variants={fadeInUp}
            className="mt-6 max-w-xl text-lg text-slate-300 leading-relaxed"
          >
            From elite private country clubs to premier racquet and fitness
            facilities, we deliver aquatic excellence to the most
            distinguished venues in Texas.
          </motion.p>
        </motion.div>
      </div>
