...
export default function ServicesHero() {
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      <Image
        src="/images/pool-water-blue.jpg"
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-ocean-400">Needs</span>
          </motion.h1>
          <motion.p
            variants={fadeInUp}
            className="mt-6 max-w-xl text-lg text-slate-300 leading-relaxed"
          >
            From comprehensive pool management to certified lifeguard staffing,
            we provide complete aquatic solutions for communities across Houston.
          </motion.p>
        </motion.div>
      </div>
