...
export default function Footer() {
  return (
    <footer className="relative bg-navy text-white">
      {/* Wave Divider */}
      <div className="wave-divider" style={{ top: "-79px", position: "relative", marginBottom: "-79px" }}>
      ...
      <div className="mx-auto max-w-7xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 text-center grid-cols-3">
          {/* Quick Links */}
          <div>
            <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-ocean-400">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-sm text-slate-400">{COMPANY.location}</li>
            </ul>
            ...
            <div className="mt-6 flex justify-center gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-slate-400 transition-all hover:bg-ocean-500 hover:text-white"
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center">
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} Aura Aquatics. All rights reserved. | Serving the Greater Houston Area
          </p>
        </div>
      </div>
    </footer>
